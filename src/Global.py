...
ladder = pygame.image.load('sprite/ladder.png')
tas_roche = pygame.image.load('sprite/tas_roche.png')
mur_mine = pygame.image.load('sprite/mur_mine.png')
sol_mine = pygame.image.load('sprite/sol_mine.png')
